...
cmus-y := \
	...
	filters.o format_print.o gbuf.o glob.o help.o history.o http.o id3.o info.o input.o \
	job.o keys.o keyval.o lib.o load_dir.o locking.o lyrics.o mergesort.o misc.o options.o \
